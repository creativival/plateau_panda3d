...
class ReadBuilding:
    def __init__(self, plateau_settings):
        self.building_attributes_list = get_building_attributes_list(plateau_settings, self.db, self.db_cursor)
        self.road_attributes_list = get_road_attributes_list(plateau_settings, self.db, self.db_cursor)
